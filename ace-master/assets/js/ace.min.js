...
function(a, b) {
    a.unCamelCase = function(a) { return a.replace(/([a-z])([A-Z])/g, function(a, b, c) { return b + "-" + c.toLowerCase() }) }, a.strToVal = function(a) {
    ...
    }, a.scrollTop = function() { return document.scrollTop || document.documentElement.scrollTop || document.body.scrollTop }, a.winHeight = function() { return window.innerHeight || document.documentElement.clientHeight }, a.redraw = function(a, b) {
        if (a) {
            var c = a.style.display;
            a.style.display = "none", a.offsetHeight, b !== !0 ? a.style.display = c : setTimeout(function() { a.style.display = c }, 10)
        }
    }
}(ace.helper), jQuery(function(a) { try { ace.demo.init() } catch (b) {} }),
    function(a, b) {
        ace.demo = {
            functions: {},
            init: function(a) {
        ...
        }, ace.demo.functions.basics = function() { ace.vars.non_auto_fixed && a("body").addClass("mob-safari"), ace.vars.transition = ace.vars.animation || !!a.support.transition }, ace.demo.functions.enableSidebar = function() {
            var b = a(".sidebar");
            ...
            if (a.fn.ace_ajax) {
                ...
                var b = { close_active: !0, close_mobile_menu: "#sidebar", close_dropdowns: !0, default_url: "page/index", content_url: function(a) { if (!a.match(/^page\//)) return !1; var b = document.location.pathname; return b.match(/(\/ajax\/)(index\.html)?/) ? b.replace(/(\/ajax\/)(index\.html)?/, "/ajax/content/" + a.replace(/^page\//, "") + ".html") : b + "?" + a.replace(/\//, "=") } };
            ...
            b && a(".dropdown-content").ace_scroll({ reset: !1, mouseWheelLock: !0 }), b && !ace.vars.old_ie && (a(window).on("resize.reset_scroll", function() { a(".ace-scroll:not(.scroll-disabled)").not(":hidden").ace_scroll("reset") }), b && a(document).on("settings.ace.reset_scroll", function(b, c) { "sidebar_collapsed" == c && a(".ace-scroll:not(.scroll-disabled)").not(":hidden").ace_scroll("reset") }))
            ...
            a(".sidebar .nav-list .badge[title],.sidebar .nav-list .badge[title]").each(function() {
                ...
                b = b ? b[0] : "tooltip-error", a(this).tooltip({ placement: function(b, c) { var d = a(c).offset(); return parseInt(d.left) < parseInt(document.body.scrollWidth / 2) ? "right" : "left" }, container: "body", template: '<div class="tooltip ' + b + '"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>' })
            })
            ...
            ace.vars.ios_safari && a(document).on("ace.settings.ios_fix", function(b, c, d) {
                ...
                }).on("blur.ios_fix", "input,textarea,.wysiwyg-editor", function() { a(window).off("scroll.ios_fix") }))
            ...
            function c(b) {
                if (b = b || a(this).find("> .dropdown-menu"), b.length > 0 && (b.css({ width: "", height: "", left: "", right: "", top: "" }).find(".dropdown-content").each(function() {
                    ...
                    }), b.hasClass("user-menu"))) { a(this).find(".user-info").css({ left: "", right: "", top: "", width: "", "max-width": "", "z-index": "" }) }
            ...
            ace.vars.old_ie || a(document).on("shown.bs.dropdown.navbar", ".ace-nav > li.dropdown-modal", function(c) {
                b.call(this);
                var d = this;
                a(window).on("resize.navbar.dropdown", function() { b.call(d) })
    ...
    function(a, b) {
        ...
        if (c.length > 0) {
            ...
            }).triggerHandler("scroll.scroll_btn"), c.on(ace.click_event, function() { var b = Math.min(500, Math.max(100, parseInt(ace.helper.scrollTop() / 3))); return a("html,body").animate({ scrollTop: 0 }, b), !1 })
        }
    }(window.jQuery),
    function(a, b) {
        function c(b, c) {
            ...
            this.force_reload = !1, this.loadUrl = function(a, b, c) {
            ...
            }, this.loadAddr = function(a, b, c) { this.force_reload = c === !1, this.getUrl(a, b, !1) }, this.reload = function() { var b = a.trim(window.location.hash);!b && this.settings.default_url && (b = this.settings.default_url), this.loadUrl(b, !1) }, this.post = function(b, c, d, e) {
                ...
                if (!j) {
                    ...
                    if (g.trigger(o = a.Event("ajaxloadstart"), { url: b, hash: c, method: i, data: l }), !o.isDefaultPrevented()) {
                        ...
                        "POST" == i && "object" == typeof n && (p = a.extend({}, p, n)), a.ajax(p).error(function() { g.trigger("ajaxloaderror", { url: b, hash: c, method: i, data: l }), h.stopLoading(!0) }).done(function(j) {
            ...
            }, this.stopLoading = function(a) { a === !0 ? (j = !1, k.remove(), l && (g.css("position", ""), l = !1), null != m && (clearTimeout(m), m = null)) : (k.addClass("almost-loaded"), g.one("ajaxscriptsloaded.inner_call", function() { h.stopLoading(!0) })) }, this.working = function() { return j }, this.loadScripts = function(b, c) {
                var b = b || [];
                ...
                setup: function() {
                    ...
                    g.on(c, function(c) {
                        ...
                        var i, j = c.originalEvent.touches ? c.originalEvent.touches[0] : c,
                            ...
                            m = 0,
                            n = 0;
                        g.on(e, h).one(d, function(a) { g.off(e, h), k = i = b })
                    })
                }
            }
        }
    ...
    function(a, b) {
        function c(b, c) {
            ...
            var h = function(b, c) { var d, e, f = a(this).find(ace.vars[".icon"]); if (f.length > 0) { d = f.attr("data-icon1"), e = f.attr("data-icon2"), "undefined" != typeof b ? b ? f.removeClass(d).addClass(e) : f.removeClass(e).addClass(d) : f.toggleClass(d).toggleClass(e); try { c !== !1 && ace.settings.saveState(f.get(0)) } catch (g) {} } },
            ...
            }, this.collapse = function(a, b) { this.collapsible || (this.minimized = !1, this.toggleMenu(a, b)) }, this.expand = function(a, b) { this.collapsible || (this.minimized = !0, this.toggleMenu(a, b)) }, this.showResponsive = function() { this.$sidebar.removeClass(l).removeClass(m) }, this.toggleResponsive = function(b, c) {
            ...
            this.show = function(b, c, d) {
                ...
                var g = function(b, c) { b && b.stopPropagation(), f.css({ "transition-property": "", "transition-duration": "", overflow: "", height: "" }), c !== !1 && f.trigger(a.Event("shown.ace.submenu")), d && (j = !1) },
                    h = b.scrollHeight;
                return 0 != c && 0 != h && a.support.transition.end ? (f.css({ height: h, "transition-property": "height", "transition-duration": c / 1e3 + "s" }).one(a.support.transition.end, g), ace.vars.android && setTimeout(function() { g(null, !1), ace.helper.redraw(b) }, c + 20)) : g(), !0
            ...
            o.call(f), a(window).on("resize.sidebar.vars", function() { e.call(f) }).triggerHandler("resize.sidebar.vars"), this.$sidebar.on(ace.click_event + ".ace.submenu", ".nav-list", function(b) {
                ...
                if (d && 0 != d.length) {
                    ...
                    if ("tap" == ace.click_event && e && d.get(0).parentNode.parentNode == c) { var l = d.find(".menu-text").get(0); if (null != l && b.target != l && !a.contains(l, b.target)) return b.preventDefault(), !1 }
        ...
        a(document).on(ace.click_event + ".ace.menu", ".menu-toggler", function(b) {
            ...
            if (0 != d.length) {
                ...
                return c.hasClass("display") ? (f && a(document).on(e, function(b) { return d.get(0) == b.target || a.contains(d.get(0), b.target) ? void b.stopPropagation() : (d.ace_sidebar("mobileToggle", this, !1), void a(document).off(e)) }), "true" == d.attr("data-sidebar-scroll") && d.ace_sidebar_scroll("reset")) : f && a(document).off(e), !1
            }
            ...
            if (c && (d = a(c)), null != d && 0 != d.length || (d = a(this).closest(".sidebar")), 0 != d.length) {
                ...
                "true" === d.attr("data-auto-hide") && (d.hasClass(responsive_max_class) ? a(document).on(f, function(b) { return d.get(0) == b.target || a.contains(d.get(0), b.target) ? void b.stopPropagation() : (d.ace_sidebar("toggleResponsive", e), void a(document).off(f)) }) : a(document).off(f))
            }
                    ...
                    A = function(b) {
                        if (!v && j.sidebar_fixed && (f = l.find(".nav-list"), h = l.find(".sidebar-toggle").eq(0), i = l.find(".sidebar-shortcuts").eq(0), g = f.get(0))) {
                            ...
                            if (f.on("ace_drag.nav", function(b) {
                                ...
                                }), j.settings.smooth_scroll && f.on("touchstart.nav MSPointerDown.nav pointerdown.nav", function(a) { f.css("transition-property", "none"), s.css("transition-property", "none") }).on("touchend.nav touchcancel.nav MSPointerUp.nav MSPointerCancel.nav pointerup.nav pointercancel.nav", function(a) { f.css("transition-property", "top"), s.css("transition-property", "top") }), d && !j.settings.include_toggle) {
                                var e = h.get(0);
        ...
        function c(b, c) {
            function h(b) {
                var c = b,
                    ...
                    e = null,
                    f = !1;
                this.show = function() { null != e && clearTimeout(e), e = null, d.addClass("hover-show hover-shown"), f = !0; for (var a = 0; a < g.length; a++) g[a].find(".hover-show").not(".hover-shown").each(function() { i(this).hide() }) }, this.hide = function() {
                ...
                }, this.is_visible = function() { return f }
            }
            ...
            this.update_vars = function() { w = "fixed" == v.css("position") }, l.dirty = !1, this.reset = function() {
            ...
            }, this.updateStyle = function(a) { sub_scroll_style = a, o.find(".submenu.ace-scroll").ace_scroll("update", { styleClass: a }) }, this.changeDir = function(a) { s = "right" === a };
            var x = -1;
                        ...
                        if (m) {
                            ...
                            if (t && !n.is_visible() || !d && s != y || r)
                                if (a(h).addClass("can-scroll"), r || d) {
                                    var u = this;
                                    setTimeout(function() { k.call(u, h) }, 0)
                                } else k.call(this, h);
                            y = s
                        } else a(h).removeClass("can-scroll");
                    t && n.show()
                }
            }).on(A, ".nav-list li, .sidebar-shortcuts", function(b) { q = o.ace_sidebar("vars"), q.collapsible || a(this).hasClass("hover-show") && t && i(this).hideDelay() })
        }
    ...
    function(a, b) {
        ...
        var d = function(b, d) {
            ...
            this.reload = function() {
                var a = this.$box,
                    b = !1;
                "static" == a.css("position") && (b = !0, a.addClass("position-relative")), a.append('<div class="widget-box-overlay"><i class="' + ace.vars.icon + 'loading-icon fa fa-spinner fa-spin fa-2x white"></i></div>'), a.one("reloaded.ace.widget", function() { a.find(".widget-box-overlay").remove(), b && a.removeClass("position-relative") })
            }, this.closeFast = function() { this.close(0) }, this.close = function(a) {
                var b = this.$box,
                    a = "undefined" == typeof a ? 300 : a;
                b.fadeOut(a, function() { b.trigger("closed.ace.widget"), b.remove() })
            }, this.toggleFast = function() { this.toggle(null, null, 0, 0) }, this.toggle = function(a, b, c, d) {
                var e = this.$box,
                ...
                "show" == h ? (g && g.removeClass(k).addClass(l), f.hide(), e.removeClass("collapsed"), f.slideDown(c, function() { e.trigger(i + ".ace.widget") })) : (g && g.removeClass(l).addClass(k), f.slideUp(d, function() { e.addClass("collapsed"), e.trigger(i + ".ace.widget") })), e.trigger("toggled.ace.widget", [h])
            }, this.hide = function() { this.toggle("hide") }, this.show = function() { this.toggle("show") }, this.hideFast = function() { this.toggle("hide", null, 0, 0) }, this.showFast = function() { this.toggle("show", null, 0, 0) }, this.fullscreen = function(a) {
    ...
    function(a, b) {
        ...
        }), a("#ace-settings-highlight").on("click", function() { this.checked ? a("#sidebar .nav-list > li").addClass("highlight") : a("#sidebar .nav-list > li").removeClass("highlight"), ace.vars.old_ie && ace.helper.redraw(a("#sidebar")[0]) }), a("#ace-settings-hover").on("click", function() {
        ...
        a(document).on("settings.ace", function(b, c, d, e, f) {
            ...
            if (g && (g = document.getElementById(g))) { a(g).prop("checked", d); try { 1 == f && ace.settings.saveState(g, "checked") } catch (h) {} }
        }), ace.settingFunction = {
    ...
    function(a, b) {
        ...
        var c = function() {
            ...
            b(), a(".page-content-area[data-ajax-content=true]").on("ajaxscriptsloaded.rtl", function() { a("body").hasClass("rtl") && b(this) })
        }
    }(jQuery),
    function(a, b) {
        ...
        a("#skin-colorpicker").on("change", function() {
            function b(b) {
                ...
                if ("no-skin" == b) {
                    var e = 0;
                    a(".sidebar-shortcuts .btn").each(function() { a(this).attr("class", "btn " + f[e++ % 4]) }), a(".sidebar[data-sidebar-scroll=true]").ace_sidebar_scroll("updateStyle", ""), a(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover("updateStyle", "no-track scroll-thin")
                } else if ("skin-1" == b) {
                    a(".ace-nav > li.grey").addClass("dark");
                    var e = 0;
                    a(".sidebar-shortcuts").find(".btn").each(function() { a(this).attr("class", "btn " + f[e++ % 4]) }), a(".sidebar[data-sidebar-scroll=true]").ace_sidebar_scroll("updateStyle", "scroll-white no-track"), a(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover("updateStyle", "no-track scroll-thin scroll-white")
    ...
    function(a, b) {
        a(document).on("reload.ace.widget", ".widget-box", function(b) {
            var c = a(this);
            setTimeout(function() { c.trigger("reloaded.ace.widget") }, parseInt(1e3 * Math.random() + 1e3))
        })
    }(window.jQuery),
